...
features=pd.read_csv('./Data/2D-Shape_Spec'+type_wav+'_'+type_sig+'_SNR='+str(snr)+'_wins='+str(ws)+'/features_final.csv',header=None)
...
pickle.dump(sc, open('./Data/2D-Shape_Spec'+type_wav+'_'+type_sig+'_SNR='+str(snr)+'_wins='+str(ws)+"/scaler_LR.pkl", "wb"))
...
# pickle.dump(rf_random, open('./Data/2D-Shape_Spec'+type_wav+'_'+type_sig+'_SNR='+str(snr)+'_wins='+str(ws)+"/model_RF.pkl", "wb"))
...
# pickle.dump(GBR, open('./Data/2D-Shape_Spec'+type_wav+'_'+type_sig+'_SNR='+str(snr)+'_wins='+str(ws)+"/model_GB.pkl", "wb"))
...
# pickle.dump(gr, open('./Data/2D-Shape_Spec'+type_wav+'_'+type_sig+'_SNR='+str(snr)+'_wins='+str(ws)+"/model_GR.pkl", "wb"))
...
pickle.dump(model_mlp, open('./Data/2D-Shape_Spec'+type_wav+'_'+type_sig+'_SNR='+str(snr)+'_wins='+str(ws)+"/model_MLP.pkl", "wb"))

hp_mlp=model_mlp.best_params_.items()
...
# pickle.dump(model_cv, open('./Data/2D-Shape_Spec'+type_wav+'_'+type_sig+'_SNR='+str(snr)+'_wins='+str(ws)+"/model_LR.pkl", "wb"))
...
pickle.dump(SVR_rs, open('./Data/2D-Shape_Spec'+type_wav+'_'+type_sig+'_SNR='+str(snr)+'_wins='+str(ws)+"/model_SVR.pkl", "wb"))

hp_SVR=SVR_rs.best_params_.items()
