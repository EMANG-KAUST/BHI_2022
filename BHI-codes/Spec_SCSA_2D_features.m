...
[RMSE,R2,Y_pred,Y_test] =pyrunfile("Spec_SCSA_ML_1D_m.py", ["RMSE","R2","y_pred_lr","y_test"],type_sig=sig_n,type_wav=wav,hscsa=num2str(h),gamma=num2str(gm),snr=SNR,ws=num2str(window_s));
